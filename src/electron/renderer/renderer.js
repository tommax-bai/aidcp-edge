...
const COMMAND_DIAGNOSTIC_LABELS = {
  ...
  'pacing.update': '更新节奏',
  'xiaohongshu.note.like': '点赞',
  'facebook.note.like': '点赞',
  'facebook.video.like': '视频点赞',
  'xiaohongshu.note.collect': '收藏',
  'xiaohongshu.user.follow': '关注',
  'facebook.user.follow': '关注',
  'xiaohongshu.note.comment': '评论',
  'facebook.note.comment': '评论',
  'xiaohongshu.comment.like': '评论点赞',
  'facebook.group.join': '群组加入',
  'xiaohongshu.navigation.back': '返回列表',
  'facebook.navigation.back': '返回列表',
  'xiaohongshu.publish.command': '发布步骤',
  'facebook.publish.command': '发布步骤',
  'task.acquire': '申请写租约',
  'task.release': '释放写租约',
