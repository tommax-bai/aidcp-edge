...
export interface SearchExecutePayload {
  ...
  taskId?: string;
  /** Search fact correlation key, generated by Cloud; old commands may omit it. */
  activityId?: string;
  /** Why the search is being performed. */
  purpose?: SearchPurpose;
  /** Whether the search is site-wide or constrained to a platform container. */
  scope?: SearchScope;
  /** 搜索关键词 */
  keyword: string;
  /** 关键词来源策略（观测用） */
...
export interface ActionCompletedPayload {
  ...
  ok: boolean;
  reason?: string;
  /** Search-only correlation and fact fields (additive for old peers). */
  activityId?: string;
  purpose?: SearchPurpose;
  scope?: SearchScope;
  /** True once the platform has observed a submitted search or search navigation. */
  actuated?: boolean;
  searchOutcome?: SearchOutcome;
  /** Visible deduplicated result count, not the platform-wide total. */
  resultCount?: number;
  /**
