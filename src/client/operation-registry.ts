...
export const CLOUD_OPERATION_REGISTRY = {
  ...
  'xiaohongshu.note.like': pageAutomation(),
  'facebook.note.like': pageAutomation(),
  'facebook.video.like': pageAutomation(),
  'xiaohongshu.note.collect': pageAutomation(),
  'xiaohongshu.user.follow': pageAutomation(),
  'facebook.user.follow': pageAutomation(),
  'xiaohongshu.note.comment': pageAutomation(),
