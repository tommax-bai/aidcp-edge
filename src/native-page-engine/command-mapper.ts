...
export const nativeCommandKindByEnvelopeType = {
  ...
  // 批 6b：{p}.note.close 已删除（关弹层是 back 的引擎内部子步骤）；navigation.back 平台段化。
  'xiaohongshu.navigation.back': 'navigation_back', 'facebook.navigation.back': 'navigation_back',
  'xiaohongshu.note.browse_images': 'note_browse_images',
...
export const nativeAllowedParamsByKind: Record<string, readonly string[]> = {
  ...
  navigation_back: ['reason', 'targetPage', 'dwellMs'],
