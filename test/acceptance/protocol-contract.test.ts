...
const ALL_MESSAGE_TYPES: Record<MessageType, true> = {
  ...
  'wechat_channels.inbox.auth.status': true,
  'wechat_channels.inbox.sync.batch': true, 'wechat_channels.inbox.sync.ack': true,
  'wechat_channels.inbox.reply.result': true,
  'wechat_channels.inbox.reply.result.ack': true,
  'wechat_channels.inbox.reply.reconcile': true, 'wechat_channels.inbox.reply.reconcile.result': true,
  'wechat_channels.inbox.sync.request': true, 'wechat_channels.inbox.reply.send': true,
  'wechat_channels.inbox.auth.reopen': true,
  'wechat_channels.inbox.browser.control': true,
  'wechat_channels.inbox.runtime.controls': true,
  'wechat_channels.inbox.offboard.command': true, 'wechat_channels.inbox.offboard.result': true, 'wechat_channels.inbox.offboard.ack': true,
